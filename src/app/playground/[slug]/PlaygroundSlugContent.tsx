...
export function PlaygroundSlugContent({ item }: PlaygroundSlugContentProps) {
  ...
  return (
    <div className="page-shell py-12 sm:py-16">
      <Link
        href="/projects"
        className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 mb-6 inline-flex items-center gap-1.5 transition-colors"
      >
