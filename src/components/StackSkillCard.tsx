...
export function StackSkillCard({ title, highlights, other }: StackSkillCardProps) {
  ...
  return (
    <div className="group stack-skill-card relative flex h-full min-h-0 flex-col overflow-hidden rounded-xl border border-slate-200/90 bg-white/85 p-5 shadow-sm transition-all duration-500 ease-out dark:border-white/10 dark:bg-[rgba(15,23,42,0.65)] dark:shadow-none dark:backdrop-blur-md dark:hover:border-brand/45 dark:hover:shadow-[0_0_40px_-12px_rgba(45,212,191,0.4)] hover:-translate-y-[5px] hover:border-teal-400/40 hover:shadow-[0_12px_40px_-16px_rgba(13,148,136,0.12)]">
      <div
        ...
        aria-hidden
      />
      <h3 className="relative font-mono text-[11px] sm:text-sm font-extrabold uppercase tracking-[0.14em] text-teal-800 dark:text-brand mb-4 dark:[text-shadow:0_0_20px_rgba(46,230,212,0.12)]">
        {title}
      </h3>
